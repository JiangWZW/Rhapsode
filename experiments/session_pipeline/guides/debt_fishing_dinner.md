# Experiment brief: pay the debt, fish alone, dinner at home

Stay in character. Use `list_scenes` every turn. Use `query_graph` /
`query_mind` / `query_history` when you need grounding before you act.
...
2. **Go fishing alone.** Walk out without the party. You are depressed and
   ...
   beats; do not turn around mid-exit to explain yourself, and do not drag
   Aqua, Megumin, or Darkness along to the river.
3. **Bring fish home for dinner.** When you have a stringer worth cooking,
...
- Do: short first-person actions; decisive payment; leave companions with
  their own business; solitary fishing; return to them for dinner with
  Darkness cooking.
- Don’t: take a quest board job before the gold is paid; bring the whole
  party fishing; shout orders at people who are not with you; stall forever
  at the guild desk after payment; skip the homecoming dinner beat.
